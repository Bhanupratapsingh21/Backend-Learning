      ...
      <div className="bg-white sm:w-[50vw] w-[100vw]  h-20 flex items-center justify-between px-2 sm:px-8 dark:bg-black dark:text-white text-black">
                <label className='sm:hidden block -mr-4'>
                    ...
                    >
                        ...
                        <div
                            class="w-[70%] h-[4px] dark:bg-white bg-black rounded-sm transition-all duration-300 origin-left translate-y-[0.9rem] peer-checked:rotate-[-45deg]"
                        ></div>
                        <div
                            class="w-[70%] h-[4px] dark:bg-white bg-black rounded-md transition-all duration-300 origin-center peer-checked:hidden"
                        ></div>
                        <div
                            class="w-[70%] h-[4px] dark:bg-white bg-black rounded-md transition-all duration-300 origin-left -translate-y-[0.9rem] peer-checked:rotate-[45deg]"
                        ></div>
                    </div>
                </label>
